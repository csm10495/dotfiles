...
if [[ "$COMMIT_HASH" != "" && "$PYTHON" != "" ]]; then
    ...
    $CURL_LOW_TIMEOUT -s https://raw.githubusercontent.com/csm10495/dotfiles/master/home/.bash_profile > ~/.bash_profile
    $CURL_LOW_TIMEOUT -s https://raw.githubusercontent.com/csm10495/dotfiles/master/home/.bashrc > ~/.bashrc
fi

# Lets also add git-completion
$CURL_LOW_TIMEOUT -s https://raw.githubusercontent.com/git/git/master/contrib/completion/git-completion.bash > ~/.git-completion.bash
